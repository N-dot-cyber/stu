...
function preload(){
  ...
  newTrexImage = loadImage("newTrex.png");
...
function setup() {
 ...
 // trex.addAnimation("running", trex_running);
  ...
  invisibleGround = createSprite(200,ground.y+55,width,125);
...
function draw() {
  ...
  if (gameState===PLAY){ 
    ...
    if(touches.length>0 || keyDown("space") && trex.y >= 127) {
      trex.velocityY = -12;
      touches = [];
    }
  console.log(trex.y)
